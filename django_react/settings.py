...
from django.conf.locale.ru import formats as formats
...
SECRET_KEY = 'django-insecure-6_#py=eac%24j(a2p5jsxr5^d^ok@&)iybzgps7v&j=!46dsqo'
...
LOGGING = {
    ...
    'loggers': {
        '': {  # Корневой логгер
            'handlers': ['console'],
            'level': 'DEBUG',  # Уровень DEBUG, чтобы видеть debug сообщения
        },
    },
}
